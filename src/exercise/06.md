...
- Use React hooks (useState, useEffect) to fetch data, e.g. from an API, and use
  this in my application
- Handle errors from fetch requests with useState
- Handle different types of error using ErrorBoundary components, both writing
  my own as well as using the react-error-boundary library
